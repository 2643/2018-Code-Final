...
public class Robot extends IterativeRobot {
	...
	public void teleopPeriodic() {
		...
		/*if(RobotMap.driveStick.getRawButton(1)) {
			RobotMap.elevator1.getSensorCollection().
		}*/
		
		//System.out.println(RobotMap.leftDrive1.getSensorCollection().getQuadraturePosition()/2 + "\t" + RobotMap.rightDrive1.getSensorCollection().getQuadraturePosition()/2 + "\t" + Elevator.getEncoderValues());
		/* Elevator code
		...
		//System.out.println(Elevator.getEncoderValues() + "\t" + RobotMap.elevator1.getOutputCurrent() + "\t" + RobotMap.leftDrive1.getOutputCurrent() + "\t" + RobotMap.rightDrive1.getOutputCurrent());
